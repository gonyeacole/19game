    ...
    <div className="mx-auto flex max-w-sm flex-col gap-4 px-4 py-16">
      ...
      <form onSubmit={submit} className="flex flex-col gap-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="rounded-full bg-led px-4 py-2 text-sm font-bold text-pill-text transition-transform active:scale-95 disabled:opacity-40 disabled:active:scale-100"
        >
